...
(function() {
	...
	for (var i = 0; i < tooltips.length; i++) {
		tooltips[i].onmouseover = function(m) {
			...
			tooltip.setAttribute('style', 'max-width:' + options.maxWidth + ';z-index:999;background-color:rgba(0,0,0,.9);font:11px/15px normal;font-family:sans-serif;color:white;padding:7px;border-radius:0 3px 3px 3px;position:absolute;top:' + (rect.bottom + 7 + options.offset.top) + 'px;left:' + (m.x + options.offset.left) + 'px');
